...
namespace clq
{
std::pair<double, std::vector<int>> run_louvain(int* from, int* to, double* w, int n_edges, double* null_model_input, int num_null_vectors, double time) {
...
PYBIND11_MODULE(cpp, m) {
    ...
    m.def("run_louvain", clq::run_louvain);
